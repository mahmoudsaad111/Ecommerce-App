...
const {addProductToCart,getCart,clearCart,updateItemQuantity,deleteItemFromCart}=require('../services/cartService');
...
exports.updateItemQuantity = asyncHandler(async (req, res,next) => {
   const cart=await updateItemQuantity (req.body,req.params.productId,req.user); 
